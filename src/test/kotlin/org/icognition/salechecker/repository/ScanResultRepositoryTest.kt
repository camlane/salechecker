...
class ScanResultRepositoryTest {
  ...
  private fun saveSiteItem(product: Product,
                           site: Site,
                           url: String,
                           price: BigDecimal): SiteItem {
  ...
  private fun saveProduct(name: String): Product {
    return productRepository.save(Product(name)).block()!!
  }

  private fun saveSite(name: String, cssSelector: String): Site {
    return siteRepository.save(Site(name, cssSelector)).block()!!
  }
